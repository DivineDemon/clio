...
import { CheckCircle, Clock, Copy, Download, Eye, RefreshCw, XCircle } from "lucide-react";
    ...
    return (
      <div className="rounded-lg bg-white shadow dark:bg-slate-800">
        <div className="border-gray-200 border-b px-6 py-4 dark:border-gray-700">
          <h2 className="font-semibold text-gray-900 text-lg dark:text-white">Recent Activity</h2>
        </div>
        <div className="p-6">
      ...
      <div className="rounded-lg bg-white shadow dark:bg-slate-800">
        ...
        <div className="p-6">
          <div className="py-12 text-center">
            ...
            <h3 className="mt-4 font-semibold text-gray-900 text-lg dark:text-white">No recent activity</h3>
            <p className="mt-2 text-gray-600 dark:text-gray-300">Your README generation jobs will appear here.</p>
          </div>
        </div>
      </div>
    );
