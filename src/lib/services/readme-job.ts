...
export async function getReadmeJobsByUserId(
	userId: string,
	status?: JobStatus,
): Promise<ReadmeJob[]> {
...
export async function getReadmeJobsByRepositoryId(
	repositoryId: string,
): Promise<ReadmeJob[]> {
	return await db.readmeJob.findMany({
		where: { repositoryId },
...
export async function updateReadmeJob(
	id: string,
	data: UpdateReadmeJobData,
): Promise<ReadmeJob> {
...
export async function createReadmeVersion(
	data: CreateReadmeVersionData,
...
export async function getReadmeVersionById(
	id: string,
): Promise<ReadmeVersion | null> {
...
export async function getLatestReadmeVersion(
	jobId: string,
): Promise<ReadmeVersion | null> {
...
export async function getReadmeVersionsByJobId(
	jobId: string,
): Promise<ReadmeVersion[]> {
