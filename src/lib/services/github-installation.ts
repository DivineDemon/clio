...
export async function createInstallation(data: CreateInstallationData): Promise<GitHubInstallation> {
...
export async function getInstallationById(id: string): Promise<GitHubInstallation | null> {
...
export async function getInstallationByInstallationId(installationId: number): Promise<GitHubInstallation | null> {
  return await db.gitHubInstallation.findUnique({
...
export async function getInstallationsByUserId(userId: string): Promise<GitHubInstallation[]> {
...
export async function isInstallationActive(installationId: number): Promise<boolean> {
